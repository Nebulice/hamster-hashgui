package nebulice.hamster.hashGui.hashgui.manager;

import nebulice.hamster.hashGui.hashgui.handler.destroy.DestroyManager;
import nebulice.hamster.hashGui.hashgui.handler.hold.HoldManager;
import nebulice.hamster.hashGui.hashgui.handler.hit.HitManager;
import nebulice.hamster.hashGui.hashgui.listener.*;
import nebulice.hamster.hashGui.hashitem.common.DefaultItems;
import net.kyori.adventure.text.Component;
import org.bukkit.plugin.PluginManager;
import org.bukkit.plugin.java.JavaPlugin;

import nebulice.hamster.hashGui.hashgui.handler.click.ClickManager;
import nebulice.hamster.hashGui.hashgui.handler.interact.InteractionManager;
